...
if direction.lower() == "right": 
    ...
    if lake.lower() == "swim":
        print("y have drowned")
    elif lake.lower() == "wait":
        doors = input(print("You arrive at the island unharmed. There is a house with 3 doors. One red, one yellow and one blue. Which colour do you choose?\n"))
        if doors.lower() == "red":
            print("u have beeen burned")
